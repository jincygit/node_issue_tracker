...
---------------------------------algorithm fo0r issue tracker project-----------------
1. render home page
2. style view pages(setup html css for pages( listing page, home page, form page))
3. add schemas
4. add functionality and routes
5. add ajax for frontend filtering, listing, adding
---------------------------------url for running-------------------------
